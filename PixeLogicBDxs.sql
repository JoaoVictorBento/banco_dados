...
INSERT INTO `funcoes` VALUES ('função de fornecedores',1),('função de produtos',1),('função de clientes',1),('função de serviços',1),('função de vendas',1),('função de relatorio_produtos',1),('função de relatorio_serviços',0),('função de suporte',1),('função de colaboradores',1);
...
INSERT INTO `usuario` VALUES ('joao','joao@desenvolvedor','1234','desenvolvedor'),('jhonnes','jhonnes@usuario','1234','chefe de cozinha');
...
-- Dump completed on 2023-09-15 12:52:33
